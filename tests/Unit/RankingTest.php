...
class RankingTest extends TestCase {
    ...
    public function setUp():void {
        ...
        $this -> data = new Data();
        $this -> match0 = ['id' => 123, 'team0' => 1, 'team1' => 3, 'score0' => 3, 'score1' => 5, '2048-01-01 00:00:00'];
        $this -> match1 = ['id' => 231, 'team0' => 4, 'team1' => 2, 'score0' => 2, 'score1' => 2, '2048-01-01 00:00:00'];
        $this -> match2 = ['id' => 222, 'team0' => 3, 'team1' => 2, 'score0' => 1, 'score1' => 3, '2048-01-01 00:00:00'];
    }
    ...
    function testTeamWinsMatch() : void {
        ...
        $this->assertNotTrue($this->ranking->teamWinsMatch(4, $this->match0)); // ici test team id correcte 
    }
